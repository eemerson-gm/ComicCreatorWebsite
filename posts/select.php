<?php
    ...
    function posts_select_recent($web_site, $number){
        ...
        $sql = "SELECT * FROM table_blog_posts WHERE web_site = ? OR web_site_2 = ? ORDER BY date DESC LIMIT ?;";
        ...
        mysqli_stmt_bind_param($stmt, "ssi", $web_site, $web_site, $number);
    ...
    //Selects all of the blog posts for the website sorted by date.
    function posts_select_website($web_site){

        //Requires the database to create the blog posts.
        require $_SERVER["DOCUMENT_ROOT"]."/posts/database.php";

        //Gets the insert sql statement from creating the blog post.
        $sql = "SELECT * FROM table_blog_posts WHERE web_site = ? OR web_site_2 = ? ORDER BY category DESC;";
        ...
        //Binds the parameters to the statement.
        mysqli_stmt_bind_param($stmt, "ss", $web_site, $web_site);
    ...
    //Selects a random blog post for the websites.
    function posts_select_random($web_site){

        //Requires the database to create the blog posts.
        require $_SERVER["DOCUMENT_ROOT"]."/posts/database.php";

        //Gets the insert sql statement from creating the blog post.
        $sql = "SELECT * FROM table_blog_posts WHERE (web_site = ? OR web_site_2 = ?) AND stars > 3 ORDER BY RAND() LIMIT 1;";
    ...
    function posts_select_category($web_site, $category){
        ...
        //Gets the insert sql statement from creating the blog post.
        $sql = "SELECT * FROM table_blog_posts WHERE (web_site = ? OR web_site_2 = ?) AND category = ? ORDER BY date DESC;";
        ...
        //Binds the parameters to the statement.
        mysqli_stmt_bind_param($stmt, "sss", $web_site, $web_site, $category);
    ...
    //Selects  posts from the category limited by number.
    function posts_select_category_limit($web_site, $category, $limit){

        //Requires the database to create the blog posts.
        require $_SERVER["DOCUMENT_ROOT"]."/posts/database.php";

        //Gets the insert sql statement from creating the blog post.
        $sql = "SELECT * FROM table_blog_posts WHERE (web_site = ? OR web_site_2 = ?) AND category = ? ORDER BY date DESC LIMIT ?;";
        ...
        //Binds the parameters to the statement.
        mysqli_stmt_bind_param($stmt, "sssi", $web_site, $web_site, $category, $limit);
